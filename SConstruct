...
default_library_name = "networklib"
default_target_path = "dll/"
...
env.Append(CPPPATH=[".","SITClient/include","SITCommon/include","commonlibs/asio/include",godot_headers_path, cpp_bindings_path + "include/", cpp_bindings_path + "gen/include/"])
